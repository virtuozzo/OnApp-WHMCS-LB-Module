$( document ).ready( function () {
	...
	for( var option in servers ) {
		...
		servers_html += '<option value="' + option + '"' + selected + '>' + '' + servers[option].name + '</option>';
	}
...
function autoscaling_row_html( labels, names ) {
	...
	for( var option in minutes ) {
		minutesSelect += '<option value="' + minutes[option] + '">' + '' + minutes[option] + '</option>';
	}
